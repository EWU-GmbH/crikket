...
If you plan to use the built-in Caddy production setup, create your DNS records before starting the stack and wait until they resolve from public resolvers.
...
Both commands should return your VPS public IP before you bring up the HTTPS stack.
